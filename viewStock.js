...
class ViewStockManager {
    ...
    createActionButtons(roll) {
        ...
        const isDefaultRoll = roll.rollnumber === '123456'; // Check for default roll
    ...
    async showEditModal(rollNumber) {
        // Prevent showing edit modal for the default roll
        if (rollNumber === '123456') {
            this.showMessage('This default roll cannot be edited.', 'warning');
            return;
        }
