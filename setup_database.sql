...
-- Insert default roll (non-editable/deletable)
INSERT IGNORE INTO rolls (rollnumber, mainrollnumber, material, papercompany, gsm, width, length, weight, lotno, squaremeter, rolltype, status, date_added)
VALUES ('123456', '123456 (Main)', 'Chromo', 'Camline', 80, 1000, 2000, 2000.00, 'Lot/Batch/Invoice - 04/025/123', 100.00, 'Main Roll', 'Stock', '2025-05-30 13:25:56');
